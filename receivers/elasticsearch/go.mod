module github.com/prometheus/prometheus-opentelemetry-collector/receivers/elasticsearch

go 1.25.8

require (
	github.com/go-viper/mapstructure/v2 v2.5.0
	github.com/prometheus-community/elasticsearch_exporter v1.10.1-0.20260616140234-2cccbfe50079
