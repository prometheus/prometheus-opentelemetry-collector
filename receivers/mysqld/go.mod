module github.com/prometheus/prometheus-opentelemetry-collector/receivers/mysqld

go 1.25.8

require (
	github.com/prometheus/client_golang v1.23.2
	github.com/prometheus/mysqld_exporter v0.19.1-0.20260619204508-def89f02e1e5
