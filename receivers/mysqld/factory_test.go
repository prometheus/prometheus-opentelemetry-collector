...
func TestFactory_DefaultConfigDerivesExporterDefaults(t *testing.T) {
	...
	want := map[string]interface{}{
		...
		"exporter_lock_wait_timeout_seconds": config.DefaultExporterLockWaitTimeoutSeconds,
		"slow_log_filter":                    config.DefaultSlowLogFilter,
		"exporter_query_timeout":             config.NewConfigWithDefaults().ExporterQueryTimeout.String(),
		"exporter_max_open_conns":            config.DefaultExporterMaxOpenConns,
...
func TestFactory_CreateMetrics_DecodesUntaggedConfig(t *testing.T) {
	...
	err := createMetrics(t, map[string]interface{}{
		...
		"exporter_lock_wait_timeout_seconds": 5,
		"slow_log_filter":                    true,
		"exporter_query_timeout":             "1s",
		"exporter_max_open_conns":            3,
